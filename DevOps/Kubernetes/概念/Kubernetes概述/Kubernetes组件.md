...
下图展示了包含所有相互关联的组件的 Kubernetes 集群。

![components-of-kubernetes](../../../../resource/DevOps/Kubernetes/concepts/components-of-kubernetes.svg)
...
公开了 Kubernetes API，是 Kubernetes 控制面的前端，Kubernetes API 服务器的主要实现。kube-apiserver 设计上考虑了水平伸缩，也就是说，它可通过部署多个实例进行伸缩。 你可以运行 kube-apiserver 的多个实例，并在这些实例之间平衡流量。
